...
> Mirror of `CLAUDE.md` for Codex and other agents. **`CLAUDE.md` is the source of truth** —
> in particular its `Session state / RESUME HERE` section. If the two ever disagree, believe
> `CLAUDE.md` and re-copy this file.
